...
The company I was working with already had an existing product. The product consisted of a postgresql database, a BI tool, and a microservice that was subscribing to event data coming from other services from the backend and mapping the data into fact and dimension tables in the postgresql database.
